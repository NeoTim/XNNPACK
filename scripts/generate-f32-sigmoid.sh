...
tools/xngen src/f32-sigmoid/wasmsimd-p5-div.c.in -D BATCH_TILE=12 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-p5-div-x12.c
tools/xngen src/f32-sigmoid/wasmsimd-p5-div.c.in -D BATCH_TILE=16 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-p5-div-x16.c
tools/xngen src/f32-sigmoid/wasmsimd-p5-div.c.in -D BATCH_TILE=20 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-p5-div-x20.c
tools/xngen src/f32-sigmoid/wasmsimd-p5-div.c.in -D BATCH_TILE=24 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-p5-div-x24.c

tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=4  -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x4.c
tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=8  -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x8.c
tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=12 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x12.c
tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=16 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x16.c
tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=20 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x20.c
tools/xngen src/f32-sigmoid/wasmsimd-lut64-p2-div.c.in -D BATCH_TILE=24 -D BLEND=0 -o src/f32-sigmoid/gen/wasmsimd-lut64-p2-div-x24.c
