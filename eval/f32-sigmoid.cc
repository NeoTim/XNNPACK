  ...
  size_t tile_size)
{
  ...
  static void f32_sigmoid__avx_rr1_p5_div(benchmark::State& state) {
    SigmoidError(state, xnn_math_f32_sigmoid__avx_rr1_p5_div, 8);
  }
  static void f32_sigmoid__avx_rr2_p5_nr1fma(benchmark::State& state) {
    SigmoidError(state, xnn_math_f32_sigmoid__avx_rr2_p5_nr1fma, 8);
  }
  static void f32_sigmoid__avx_rr2_p5_nr2fma(benchmark::State& state) {
    SigmoidError(state, xnn_math_f32_sigmoid__avx_rr2_p5_nr2fma, 8);
  }
  ...
  BENCHMARK(f32_sigmoid__avx_rr1_p5_div)
      ->Unit(benchmark::kMillisecond)
      ->Iterations(1);
  BENCHMARK(f32_sigmoid__avx_rr2_p5_nr1fma)
      ->Unit(benchmark::kMillisecond)
      ->Iterations(1);
  BENCHMARK(f32_sigmoid__avx_rr2_p5_nr2fma)
      ->Unit(benchmark::kMillisecond)
      ->Iterations(1);
