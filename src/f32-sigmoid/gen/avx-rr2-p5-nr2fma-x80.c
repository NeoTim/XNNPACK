...
void xnn_f32_sigmoid_ukernel__avx_rr2_p5_nr2fma_x80(
    size_t n,
    const float* x,
    float* y,
    const void* params)
{
  ...
  for (; n >= 80 * sizeof(float); n -= 80 * sizeof(float)) {
    ...
    lo = _mm256_extractf128_ps(vn6, 0);
    hi = _mm256_extractf128_ps(vn6, 1);
    lo = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(lo), 23));
    hi = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(hi), 23));
    const __m256 vs6 = _mm256_set_m128(hi, lo);
    lo = _mm256_extractf128_ps(vn7, 0);
    hi = _mm256_extractf128_ps(vn7, 1);
    lo = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(lo), 23));
    hi = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(hi), 23));
    const __m256 vs7 = _mm256_set_m128(hi, lo);
    lo = _mm256_extractf128_ps(vn8, 0);
    hi = _mm256_extractf128_ps(vn8, 1);
    lo = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(lo), 23));
    hi = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(hi), 23));
    const __m256 vs8 = _mm256_set_m128(hi, lo);
    lo = _mm256_extractf128_ps(vn9, 0);
    hi = _mm256_extractf128_ps(vn9, 1);
    lo = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(lo), 23));
    hi = _mm_castsi128_ps(_mm_slli_epi32(_mm_castps_si128(hi), 23));
    const __m256 vs9 = _mm256_set_m128(hi, lo);
    ...
    tmp = _mm256_mul_ps(vr2, vd2);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr2 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr2), vr2);
    tmp = _mm256_mul_ps(vr3, vd3);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr3 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr3), vr3);
    tmp = _mm256_mul_ps(vr4, vd4);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr4 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr4), vr4);
    tmp = _mm256_mul_ps(vr5, vd5);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr5 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr5), vr5);
    tmp = _mm256_mul_ps(vr6, vd6);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr6 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr6), vr6);
    tmp = _mm256_mul_ps(vr7, vd7);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr7 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr7), vr7);
    tmp = _mm256_mul_ps(vr8, vd8);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr8 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr8), vr8);
    tmp = _mm256_mul_ps(vr9, vd9);
    tmp2 = _mm256_sub_ps(vone, tmp);
    vr9 = _mm256_add_ps(_mm256_mul_ps(tmp2, vr9), vr9);
